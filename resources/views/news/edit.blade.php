                ...
                <form action="{{ route('news.update', $news->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <div class="radio">
                                <input class="form-check-input" type="radio" name="status" value="1" {{ $news->status== '1' ? 'checked' : '' }}>
                                <label class="form-check-label">
                                    Enabled
                                </label>
                            </div>
                            <div class="radio">
                                <input class="form-check-input" type="radio" name="status" value="0" {{ $news->status=='0' ? 'checked' : '' }}>
                                <label class="form-check-label">
                                    Disabled
                                </label>
                            </div>
